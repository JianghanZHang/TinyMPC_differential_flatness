...
\begin{equation}\label{eq:contraction}
  \|\delta x_k\| \;\leq\; c \; \rho(A_{\mathrm{cl}})^k \; \|\delta x_0\|,
  \qquad c \geq 1,
\end{equation}
where $\delta x_k = x_k - x^*(\balpha)$,
$\rho(A_{\mathrm{cl}}) < 1$ is the spectral radius,
...
spectral radius $\rho(A_{\mathrm{cl}}^\mu) > \rho(A_{\mathrm{cl}})$.
...
\begin{equation}\label{eq:tracking_bound}
  \rho(\tilde{A}_{\mathrm{cl}})
  \;\leq\; \rho(A_{\mathrm{cl}})
...
\begin{figure}[t]
  ...
  \caption{Circle-in-square constrained tracking:
    ...
    the Barrier Template shows partial constraint awareness;
    the Analytic Template tracks the full circle.
